...
__all__ = ['SeismicModel', 'Model', 'ModelElastic',
           'ModelViscoelastic', 'ModelViscoacoustic', 'AnisoSeismicModel']
...
class AnisoSeismicModel(SeismicModel):
    """
    The general anisotropy physical model.

    Parameters
    ----------
    Same as SeismicModel, with additional parameters to process 21 elastic parameter:
    
    cij (i,j from 1 to 6): array_like or float 
        elastic constant in GPa
    
    
    """
    _known_parameters = ['damp', 'vp', 'b', 'qp', 'qs',
                                ...
                                'c22', 'c23', 'c24', 'c25', 'c26',
                                       'c33', 'c34', 'c35', 'c36',
                                              'c44', 'c45', 'c46',
                                                     'c55', 'c56',
                                                            'c66']
    _stiffness_parameters = ['c11', 'c12', 'c13', 'c14', 'c15', 'c16',
                                    'c22', 'c23', 'c24', 'c25', 'c26',
                                           'c33', 'c34', 'c35', 'c36',
                                                  'c44', 'c45', 'c46',
                                                         'c55', 'c56',
    ...
    def _initialize_physics(self, vp, space_order, **kwargs):
        ...
        # Buoyancy
        b = kwargs.get('b', 1)
        c11 = kwargs.get('c11', 0)
        c12 = kwargs.get('c12', 0)
        c13 = kwargs.get('c13', 0)
        c14 = kwargs.get('c14', 0)
        c15 = kwargs.get('c15', 0)
        c16 = kwargs.get('c16', 0)
        
        c22 = kwargs.get('c22', 0)
        c23 = kwargs.get('c23', 0)
        c24 = kwargs.get('c24', 0)
        c25 = kwargs.get('c25', 0)
        c26 = kwargs.get('c26', 0)
        
        c33 = kwargs.get('c33', 0)
        c34 = kwargs.get('c34', 0)
        c35 = kwargs.get('c35', 0)
        c36 = kwargs.get('c36', 0)
        
        c44 = kwargs.get('c44', 0)
        c45 = kwargs.get('c45', 0)
        c46 = kwargs.get('c46', 0)
        
        c55 = kwargs.get('c55', 0)
        c56 = kwargs.get('c56', 0)
        
        c66 = kwargs.get('c66', 0)
        ...
        for name in self._known_parameters:
            ...
            # if stiffness is not given, set it to zero.
            elif name in self._stiffness_parameters:
                field = self._gen_phys_param(0, name, space_order)
                setattr(self, name, field)
                params.append(name)
    ...
    def dm(self):
        ...
        Operator(Eq(dm, div(self.vp)), subs=self.spacing_map)()
        return dm
    def get2Dstiffness(self):
        """
        Return a 6 * 6 Voigt notation Array for a single grid
        """
        from sympy import Array
        composed  = Array([[self.c11, self.c12, self.c13, self.c14, self.c15, self.c16],
...
ModelElastic = AnisoSeismicModel
ModelViscoelastic = AnisoSeismicModel
ModelViscoacoustic = AnisoSeismicModel